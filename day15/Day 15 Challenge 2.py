...
for recipe in recipes:
    ...
    if recipe.is_500_calories():
        calories_scores.append(recipe.recipe_score())

print "Max score", max(calories_scores), "found from", len(calories_scores), "recipes with 500 from", len(
    recipe_scores), "overall"
