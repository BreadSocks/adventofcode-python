        ...
        for ring in range(len(ringArray)):
            ...
            for nextRing in range(len(secondaryList)):
                ...
                if (success):
                    ...
                    print "Found losing combination"
                    maxCostArray.append(chosenWeapon[1] + chosenArmour[1] + chosenRing[1] + secondRing[1])
...
print "Highest price for losing is:", max(maxCostArray)